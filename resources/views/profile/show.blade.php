        ...
        <div class="col-md-6">
            <div class="card">
                <div class="card-header">
                    <h5 class="mb-0 card-title">Profile</h5>
                </div>
                <hr class="">
                <div class="card-body">
                    <div class="mx-auto text-center">
                        @if ($user->profile_photo_path)
                            <img src="{{ Auth::user()->profile_photo_url }}" class="rounded-circle" width="150"
                                height="150" alt="{{ $user->profile_photo_path }}">
                        @else
                            <img src="{{ asset('syetemimages/user-icon.jpg') }}" class="rounded-circle" width="150"
                                height="150" alt="">
                        @endif
                    </div>
