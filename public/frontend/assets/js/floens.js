        ...
        if (floensslickCarouselWithCounter.length) {
            floensslickCarouselWithCounter.each(function () {
                ...
                elm.on("init", function (event, slick) {
                    ...
                    elm.find(".hero-slider__counter__current").text(
                        addLeadingZero(slick.currentSlide + 1, 2)
                    );
                    elm.find(".hero-slider__counter__total").text(
                        addLeadingZero(slick.slideCount, 2)
                    );
                })
                    .slick(
