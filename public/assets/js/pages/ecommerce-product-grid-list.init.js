        ...
        if (datas[i]) {
            ...
            <div class="card ribbon-box ribbon-fill">\
                ...
                <div class="card-body pt-0">\
                    ...
                    '+ afterDiscountElem + '\
                    <a href="index.html?#apps-ecommerce-product-details.html">\
                    ...
                    <div class="mt-3 hstack gap-2">\
                        <a href="index.html?#apps-ecommerce-add-product.html" class="btn btn-primary w-100"><i class="ph-pencil me-1 align-middle"></i> Edit</a>\
                        <a href="index.html?#apps-ecommerce-product-details.html" class="btn btn-secondary w-100"><i class="ph-eye me-1 align-middle"></i> Overview</a>\
                    </div>\
                </div>\
            </div>\
        </div>';
