...
$.ajax({
    url: "assets/json/instructors-list.json",
    cache: false,
    dataType: "JSON",
    type: "GET",
    success: function (data) {
        ...
        data.forEach((element) => {
            instructorList.add({
                instructor_id: '<a href="index.html?#apps-instructors-overview.html" class="fw-medium link-primary">#TBSI1590' + element.id + '</a>',
                instructor: '<div class="d-flex align-items-center gap-2">\
                    ...
                    <a href="index.html?#apps-learning-overview.html" class="text-reset">'+ element.instructor[0].name + '</a>\
                </div>',
        ...
        instructorList.remove("instructor_id", `<a href="index.html?#apps-instructors-overview.html" class="fw-medium link-primary">#TBSI159001</a>`);
        refreshCallbacks();
        ischeckboxcheck();
    },
});
