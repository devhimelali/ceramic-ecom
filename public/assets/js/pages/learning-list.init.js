...
$.ajax({
    url: "assets/json/courses-list.json",
    cache: false,
    dataType: "JSON",
    type: "GET",
    success: function (data) {
        ...
        data.forEach((element) => {
            courseList.add({
                ...
                category: '<a href="index.html?#apps-learning-grid.html" class="text-reset">' + element.category + '</a>',
                course_Name: '<div class="d-flex align-items-center gap-2">\
                                    ...
                                    <a href="index.html?#apps-learning-overview.html" class="text-reset">'+ element.course[0].name + '</a>\
                                </div>',
        ...
        if (
            ...
            courseList.add({
                ...
                course_Name: '<div class="d-flex align-items-center gap-2">\
                    ...
                    <a href="index.html?#apps-learning-overview.html" class="text-reset">'+ courseTitleInput.value + '</a>\
                </div>',
