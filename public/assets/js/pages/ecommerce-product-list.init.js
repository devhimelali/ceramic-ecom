...
$.ajax({
    url: "assets/json/product-list.json",
    cache: false,
    dataType: "JSON",
    type: "GET",
        ...
        data.forEach((element) => {
            productList.add({
                ...
                products: '<div class="d-flex align-items-center">\
                    ...
                    <div>\
                        <h6 class="mb-0"><a href="index.html?#apps-ecommerce-product-details.html" class="text-reset text-capitalize product-title">'+ element.product[0].title + '</a></h6>\
                    </div>\
                </div>',
