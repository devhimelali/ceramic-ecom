...
$.ajax({
    url: "assets/json/property-list.json",
    cache: false,
    dataType: "JSON",
    type: "GET",
    success: function (data) {
        data.forEach((element) => {
            propertyList.add({
                id: '<a href="index.html?#apps-real-estate-property-overview.html" class="fw-medium link-primary">#TBS' + element.id + '</a>',
                propert_Name: '<img src="' + element.property[0].img + '" alt="' + element.property[0].img_alt + '" class="rounded avatar-sm object-fit-cover d-none"><a href="index.html?#apps-real-estate-property-overview.html" class="text-reset">' + element.property[0].title + '</a>',
        ...
        propertyList.remove("id", `<a href="index.html?#apps-real-estate-property-overview.html" class="fw-medium link-primary">#TBS01</a>`);
        refreshCallbacks();
        ischeckboxcheck();
    },
});
...
Array.prototype.slice.call(forms).forEach(function (form) {
    form.addEventListener('submit', function (event) {
        ...
        if (
            ...
            propertyList.add({
                id: '<a href="index.html?#apps-real-estate-property-overview.html" class="fw-medium link-primary">#TBS' + count + '</a>',
                propert_Name: '<img src="' + imageDom.src + '" alt="' + imageDom.getAttribute('alt') + '" class="rounded avatar-sm object-fit-cover d-none"><a href="index.html?#apps-real-estate-property-overview.html" class="text-reset">' + propertyTitleInput.value + '</a>',
            ...
            Array.from(editValues).forEach(function (x) {
                ...
                if (selectedId == itemId) {
                    x.values({
                        id: `<a href="index.html?#apps-real-estate-property-overview.html" class="fw-medium link-primary"> ${idFieldInput.value} </a>`,
                        propert_Name: `<img src="${imageDom.src}" alt="${imageDom.getAttribute('alt')}" class="rounded avatar-sm object-fit-cover d-none"><a href="index.html?#apps-real-estate-property-overview.html" class="text-reset">${propertyTitleInput.value}</a>`,
                        address: addressInput.value,
                        bedroom: bedroomInput.value,
                        propert_type: propertyTypeInput.value,
        ...
        Swal.fire({
            ...
            if (result.value) {
                for (i = 0; i < ids_array.length; i++) {
                    propertyList.remove("id", `<a href="index.html?#apps-real-estate-property-overview.html" class="fw-medium link-primary">${ids_array[i]}</a>`);
                }
