...
$.ajax({
    url: "assets/json/ticket-list.json",
    cache: false,
    dataType: "JSON",
    type: "GET",
    success: function (data) {
        ...
        data.forEach(function (element) {
            ...
            data.forEach((element) => {
                ticketsList.add({
                    tickets_id: `<a href="index.html?#apps-tickets-overview.html" class="fw-medium link-primary">#TBS2430190${element.id}</a>`,
                    assign: imgHtml,
    ...
    if (editBtns) {
        Array.from(editBtns).forEach(function (btn) {
            btn.addEventListener("click", function (e) {
                ...
                console.log("ticketsList", itemId)
